    ...
    <div class="grid md:grid-cols-4 gap-10 mb-12">
      ...
      <div>
        ...
        <div class="space-y-2">
          ...
          <a href="https://linkedin.com/in/manish24" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:8px;color:#8BB4CC;font-size:0.875rem;text-decoration:none;margin-top:8px;transition:color 0.2s" onmouseover="this.style.color='#00C2FF'" onmouseout="this.style.color='#8BB4CC'">
...
if(typeof THREE!=='undefined'){
  (function(){
    ...
    animate();
    window.addEventListener('resize',()=>{camera.aspect=innerWidth/innerHeight;camera.updateProjectionMatrix();renderer.setSize(innerWidth,innerHeight);},{p